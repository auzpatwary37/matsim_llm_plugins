...
public class Prompt {
	...
	public static String SystemPrompt_April2025 = "\"You are a function-calling assistant. Based on the user's question and the list of available functions, you must decide whether to call a function.\r\n"
			+ "\r\n"
			+ "Your response MUST follow this OpenAI tool-calling format:\r\n"
			+ "\r\n"
			+ "{{\r\n"
			+ "  \"role\": \"assistant\",\r\n"
			+ "  \"content\": null,\r\n"
			...
			+ "}}\r\n"
			+ "\r\n"
			+ "If no tool can be called, then respond like this:\r\n"
			+ "\r\n"
			+ "{{\r\n"
			+ "  \"role\": \"assistant\",\r\n"
			+ "  \"content\": \"Explanation of why no tool was used.\",\r\n"
			+ "  \"tool_calls\": []\r\n"
			+ "}}\r\n"
			+ "\r\n"
			+ "Your entire response MUST be a valid JSON object in this format. You must NEVER include anything outside this JSON structure.\r\n"
			+ "\r\n"
			+ "Here is a list of available functions you can invoke, in JSON format:\r\n"
			+ "\\n{functions}\\n\r\n";
	
	public static String UserPrompt_April2025 = "You are an intelligent agent operating within a traffic simulation model. You are assigned a fixed daily schedule (plan) consisting of activities and the legs (trips) between them. Each leg connects the activity before it to the one after. The daily plan always starts and ends with an activity.\r\n"
			+ "\r\n"
			+ "You control an electric vehicle (EV), and your task is to schedule charging activities based on the vehicle’s location and your activity schedule. Charging takes place at standalone charging stations, which are not co-located with normal activity facilities. Therefore, traveling to a charger and back requires dedicated legs.\r\n"
			+ "\r\n"
			+ "To insert one charging session, you must add:\r\n"
			+ "Two activities: plugin and plugout\r\n"
			+ "two additional connecting legs: two legs to reach the charger and two to return\r\n"
			+ "\r\n"
			+ "\r\n"
			+ "While the vehicle is charging, you MUST perform one or more regular activities (e.g., work, shop, leisure).\r\n"
			+ "\r\n"
			+ "Follow these behavioral rules:\r\n"
			+ "Vehicle location management:\r\n"
			+ "\r\n"
			+ "   - If the previous leg’s mode is car, set the vehicle’s location to the current activity’s location.\r\n"
			+ "   - If not, keep the vehicle location unchanged.\r\n"
			+ "   - You can only use car mode if the vehicle is already at the previous activity’s location.\r\n"
			+ "\r\n"
			+ "Plugin trip rules:\r\n"
			+ "\r\n"
			+ "   - The leg to the plugin activity must be a car leg.\r\n"
			+ "   - The leg from the plugin to the next activity must not be a car leg (car is charging).\r\n"
			+ "\r\n"
			+ "Plugout trip rules:\r\n"
			+ "\r\n"
			+ "   - The leg to the plugout activity must not be a car leg (car is at the charger).\r\n"
			+ "   - The leg from the plugout must be a car leg (you retrieve the car).\r\n"
			+ "\r\n"
			+ "If vehicle location is unknown and no leg uses car mode, assume the car starts at the first activity. Update the mode of legs accordingly and propagate the car location.\r\n"
			+ "\r\n"
			+ "\r\n"
			+ "Charging at first or last activity:\r\n"
			+ "\r\n"
			+ "   - To charge at the first activity, clone it and insert a plugin in between.\r\n"
			+ "   - To charge at the last activity, clone it and insert a plugout in between.\r\n"
			+ "   - Only the first and last activities may be cloned. Other activities must not be cloned.\r\n"
			+ "\r\n"
			+ "Use your reasoning ability as a person owning an EV to suggest the best plan minding the departure time, length and distance. \r\n"
			+ "\r\n"
			+ "Your response SHOULD be a JSON function call to dummy_plan and an explanation of the underlying logic. \r\n"
			+ "\r\n"
			+ "⚠️ Important:\r\n"
			+ "Your tool call must always include:\r\n"
			+ "\r\n"
			+ "At least one plugin activity\r\n"
			+ "\r\n"
			+ "At least one plugout activity\r\n"
			+ "\r\n"
			+ "Four corresponding legs (car, walk, walk, car) around them\r\n"
			+ "If these are missing, your output will be invalid.";
